...
class Ui_DetectoristAppUI(object):
    def setupUi(self, DetectoristAppUI):
        ...
        self.detectObjectAction = QAction(DetectoristAppUI)
...
#if QT_CONFIG(shortcut)
        self.cropAction.setShortcut(QCoreApplication.translate("DetectoristAppUI", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.detectObjectAction.setText(QCoreApplication.translate("DetectoristAppUI", u"Detect Object (AI)", None))
#if QT_CONFIG(shortcut)
